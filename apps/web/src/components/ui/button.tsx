...
const buttonVariants = cva(
  ...
  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50`,
  {
    variants: {
      variant: {
    ...
    compoundVariants: [
      {
        size: 'icon',
        variant: 'ghost',
        className: 'rounded-sm focus-visible:ring-offset-primary',
      },
    ],
    defaultVariants: {
      variant: 'default',
