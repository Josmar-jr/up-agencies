    ...
    <div className="relative border-b">
      <DropdownMenu>
        ...
        >
          ...
          <div className="flex flex-1 items-center overflow-hidden">
            <span className="overflow-hidden text-ellipsis whitespace-nowrap font-semibold tracking-tight">
              {agency.name}
            </span>

            <ChevronDown className="mt-1/2 h-[14px]" />
          </div>
        </DropdownMenuTrigger>
        <DropdownMenuContent
          className="ml-2 mt-1 w-[280px] text-accent-foreground"
          align="start"
          forceMount
        >
      ...
      <div className="absolute right-4 top-1/2 -translate-y-4">
        <Tooltip>
          <TooltipTrigger
            type="button"
            className="group grid size-8 place-content-center rounded-lg p-3 hover:bg-muted"
          >
            <svg
              width="18"
              height="18"
            ...
            >
              ...
              <path
                ...
                className="transition-all duration-200 group-hover:-translate-x-2 group-hover:scale-90 group-hover:opacity-0"
              />
              <path
              ...
              <path
                ...
                className="translate-x-3 opacity-0 transition-all  duration-200 group-hover:translate-x-0 group-hover:opacity-100"
              />
            </svg>
          </TooltipTrigger>
