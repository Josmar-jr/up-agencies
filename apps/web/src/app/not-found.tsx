...
export default function NotFoundPage() {
  return (
    <div className="animation-delay:.85s animate-fade-in-down relative mt-2 h-screen w-full py-20 pb-10 opacity-0  delay-500 lg:mt-[4.03125rem]">
      <div className="relative isolate w-full py-0 [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] lg:pb-24 lg:pt-8 lg:[mask-image:radial-gradient(circle_at_10%_50%,white,transparent)]">
        <div
          aria-hidden
          className="absolute inset-0 hidden mix-blend-soft-light lg:[display:block]"
        >
          <PerlinNoise />
        </div>
        ...
        <div className="container relative">
          <div className="relative w-full">
            <div className="relative flex flex-col gap-4 text-foreground/80 lg:gap-8">
              <GridBorder left right overflow />

              <div className="relative flex w-full flex-col text-foreground">
                <span className="relative -ml-[.7%] text-8xl font-bold !leading-[.76] -tracking-[.06em] lg:text-[250px]">
                  <div
                    aria-hidden
                    className="pointer-events-none absolute inset-0 select-none text-primary [mask-image:linear-gradient(to_bottom,white,transparent)]"
                  >
                    404
                  </div>
              ...
              <div className="relative flex w-full flex-col text-foreground">
                ...
                <span className="-ml-1 text-6xl font-bold !leading-[.73] -tracking-[.06em] lg:text-[7.125rem]">
                  Not found.
                </span>
              </div>
              ...
              <div className="relative mt-4 flex w-full flex-col text-lg lg:mt-8 lg:text-4xl">
      ...
      {(props.left || props.right) && (
        <div
          ...
          className={cn(
            className,
            overflow &&
              '-bottom-[20%] -top-[20%] [mask-image:linear-gradient(to_bottom,transparent_3%,black_10%,black_90%,transparent_97%)]'
          )}
        >
